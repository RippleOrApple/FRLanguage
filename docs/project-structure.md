...
│  ├─ fr_bootstrap_suite.fr
│  ├─ fr_bootstrap_acceptance.fr
│  ├─ fr_toolchain_self_load_probe.fr
...
- `fr_nested_bootstrap_acceptance.fr.txt`：作为二层自举目标程序，导入 FR bootstrap 并运行默认 15 个验收用例。
